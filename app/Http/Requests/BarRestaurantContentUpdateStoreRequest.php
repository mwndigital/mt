...
class BarRestaurantContentUpdateStoreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'banner_one_big_image' => ['nullable', 'image', 'mimes:jpg,jpeg,png,svg,webp'],
            'banner_one_small_image' => ['nullable', 'image', 'mimes:jpg,jpeg,png,svg,webp'],
            'separator_banner_image' => ['nullable', 'image', 'mimes:jpg,jpeg,png,svg,webp'],
            ...
            'book_stay_banner_background_image' => ['nullable', 'image', 'mimes:jpg,jpeg,png,svg,webp'],
