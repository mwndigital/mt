...
class HomepageContentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        HomepageContent::create([
            ...
            'hero_banner_content' => 'Our bar is now open with an interim menu.  During our renovations, we offer a changing freshly prepared menu.  Please check the bar daily.',
            ...
            'banner_one_content' => "<p>We have a passion for food and whisky which is reflected in the locally sourced ingredients for our menu and our enviable selection of malts.</p><p>As private guests in the separate accommodation, you are welcome to eat or enjoy a dram in The Mash Tun Whisky Bar, where breakfast, lunch, and dinner are available.</p>",
