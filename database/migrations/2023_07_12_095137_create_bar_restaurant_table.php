...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('bar_restaurant', function (Blueprint $table) {
            ...
            $table->text('banner_one_big_image')->nullable();
            $table->text('banner_one_small_image')->nullable();
            $table->string('separator_banner_image')->nullable();
            ...
            $table->string('book_stay_banner_background_image')->nullable();
