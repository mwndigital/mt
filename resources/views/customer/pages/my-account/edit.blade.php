                    ...
                    <form action="{{ route('customer.my-account.update', $profile->id) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="town_city" id="town_city" value="@if($profile->userDetails){{ $profile->userDetails->town_city }}@endif">
                                @error('town_city')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="postcode" id="postcode" value="@if($profile->userDetails){{ $profile->userDetails->postcode }}@endif">
                                @error('postcode')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="country" id="country" required>
                                    @foreach($countries as $country)
                                        <option value="{{ $country }}" @if($profile->userDetails) @if($country == $profile->userDetails->country) selected @endif @endif @if($country === 'United Kingdom') selected @endif>{{ $country }}</option>
                                    @endforeach
                                </select>
                                @error('country')
                                    <div class="text-danger">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="dietary_information" id="dietary_information" cols="30" rows="10">@if($profile->userDetails) {{ $profile->userDetails->dietary_information }} @endif</textarea>
                            </div>
                        </div>
                        <div class="row">
