...
<a class='list-group-item list-group-item-action {{ Route::is('admin.restaurant-bookings.next-weeks-bookings') ? 'active' : '' }}' href="{{ route('admin.restaurant-bookings.next-weeks-bookings') }}">Next Weeks Bookings</a>
