                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="email" name="email" id="email"
                                       value="{{ old('email') }} example@example.com" required>
                                <small>If you do not have the customers email address please leave leave the above in or
                                    input reservations@mashtun-aberlour.com as the email address is required</small>
                                @error('email')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                <select name="table_ids[]" id="table_ids" multiple required style="height: 100px;">
                                    @foreach($tables as $table)
                                        <option value="{{ $table->id }}">{{ $table->name }} - {{ $table->no_of_seats }}
                                            seats
                                        </option>
                                    @endforeach
                                </select>
