                ...
                <div class="col-12">
                    <form action="{{ route('admin.about-us.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Title *</label>
                                <input type="text" name="about_banner_title" id="about_banner_title" value="{{ old('about_banner_title') }}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="about_banner_content" id="about_banner_content" cols="30" rows="10" class="tinyEditor" required>{{ old('about_banner_content') }}</textarea>
