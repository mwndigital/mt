...
@section('content')
    ...
    <section class="pageMain mb-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.bar-restaurant.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Title * </label>
                                <input type="text" name="banner_one_titke" id="banner_one_title" value="{{ old('banner_one_title') }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Title *</label>
                                <input type="text" name="book_stay_banner_title" id="book_stay_banner_title" value="{{ old('book_stay_banner_title') }}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Content *</label>
                                <textarea name="book_stay_banner_content" id="book_stay_banner_content" cols="30" rows="10" class="tinyEditor" required>{{ old('book_stay_banner_content') }}</textarea>
