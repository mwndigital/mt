                ...
                <div class="col-12">
                    <div class="btn-group">
                        ...
                        @if($booking->status != 'confirmed' && $booking->status != 'paid')
                            <a href="{{ route('admin.booking-status', $booking->id) }}?status=confirmed"
                               class="btn btn-success" onclick="confirmBooking(event)">Confirm</a>
                        @endif
                ...
                <div class="col-12">
                    <table class="table table-responsive w-100">
                        ...
                        <tr>
                            ...
                            <td><span class="text-success">£{{$booking->getCapturedAmount()}}</span> - <small>Remaining
                                    :
                                    <span
                                        class="text-danger">£{{ $booking->total - $booking->getCapturedAmount()}}</span></small>
                            </td>
                        </tr>
                        <tr>
