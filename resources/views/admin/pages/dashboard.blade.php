            ...
            <div class="row">
                    ...
                    <div class="whiteBoxItem">
                        ...
                        <div class="tab-panels-wrap">
                            <div class="list-group" id="list-tab" role="tablist">
                                <a href="" class="list-group-item list-group-item-action active" data-bs-toggle="list" href='#restaurant-list-latest' role="tab">
                                    Latest Bookings
                                </a>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="restaurant-list-latest" role="tabpanel">
                                    <table class="table w-100">
                                        ...
                                        <tbody>
                                        @foreach($newestRestaurantBookings as $today)
                                            <tr>
                                                <td>{{ $today->first_name }} {{ $today->last_name }}</td>
                                                <td>{{ $today->reservation_time }}</td>
                                                <td>{{ date('d/m/Y', strtotime($today->reservation_date)) }}</td>
                                ...
                                <div class="tab-pane fade show" id="restaurant-list-today" role="tabpanel">
                                    <table class="table w-100">
                                        <thead>
                                        <tr>
                                            <th>Name</th>
                ...
                <div class="col-12">
                    <div class="whiteBoxItem">
                        ...
                        <div class="tab-panels-wrap">
                            <div class="list-group" id="list-tab" role="tablist">
                                <a class="list-group-item list-group-item-action active" data-bs-toggle="list" href="#room-list-latest" role="tab">Latest Bookings</a>
                                <a class="list-group-item list-group-item-action" data-bs-toggle="list"
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="room-list-latest" role="tabpanel">
                                    <table class="table w-100">
                                        <thead>
                                        <tr>
                                            <th>Name</th>
                                        ...
                                        @foreach($roomToday as $today)
                                            <tr>
                                                ...
                                                <td style="text-align: right;">{{ date('d/m/Y', strtotime($today->created_at)) }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                                </div>
                                <div class="tab-pane fade show" id="room-list-today" role="tabpanel">
                                    <table class="table w-100">
                                        <thead>
                                        <tr>
                                            <th>Name</th>
