...
@section('content')
    ...
    <section class="pageMain">
        <div class="container">
            <div class="row">
                <form action="{{ route('admin.rooms-page.update', ['rooms_page' => $content->id]) }}" method="post"
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" name="page_title" id="page_title"
                                   value="{{ old('page_title', $content->page_title) }}">
                            @error('page_title')
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" name="hero_banner_title" id="hero_banner_title"
                                   value="{{ old('hero_banner_title', $content->hero_banner_title) }}" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            @if($content->hero_banner_background_image)
                                <img class="img-fluid" src="{{ Storage::url($content->hero_banner_background_image) }}"
