                    ...
                    <form action="{{ route('admin.bar-page.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="hero_title" id="hero_title" value="{{ old('title') }}"
                                       required>
                                @error('hero_title')
                                <div class="text-danger">
                                    {{ $message }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="hero_content" id="hero_content" cols="30" rows="10" class="tinyEditor"
                                          required>{{ old('hero_content') }}</textarea>
                                @error('hero_content')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="banner_two_content" id="banner_two_content" cols="30" rows="10"
                                          class="tinyEditor">{{ old('banner_two_content') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="banner_three_title" id="banner_three_title"
                                       value="{{ old('banner_three_title') }}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="banner_three_content" id="banner_three_content" cols="30" rows="10"
                                          class="tinyEditor">{{ old('banner_three_content') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="book_banner_button_content" id="book_banner_button_content"
                                       value="{{ old('book_banner_button_content') }}" required>
