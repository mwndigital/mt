...
@section('content')
    ...
    <section class="pageMain">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.bar-page.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="hero_title" id="hero_title" value="{{ old('title') }}" required>
                                @error('hero_title')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Content *</label>
                                <textarea name="banner_two_content" id="banner_two_content" cols="30" rows="10" class="tinyEditor">{{ old('banner_two_content') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Content *</label>
                                <textarea name="banner_three_content" id="banner_three_content" cols="30" rows="10" class="tinyEditor">{{ old('banner_three_content') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Title *</label>
                                <input type="text" name="book_banner_title" id="book_banner_title" value="{{ old('book_banner_title') }}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Content *</label>
                                <textarea name="book_banner_content" id="book_banner_content" cols="30" rows="10" class="tinyEditor" required> {{ old('book_banner_content') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <label for="">Background Image *</label>
                                <input type="file" name="book_banner_background_image" id="book_banner_background_image" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="book_banner_button_content" id="book_banner_button_content" value="{{ old('book_banner_button_content') }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="book_banner_button_link" id="book_banner_button_link" value="{{ old('book_banner_button_link') }}" required>
