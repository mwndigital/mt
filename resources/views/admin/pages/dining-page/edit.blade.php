...
@section('content')
    ...
    <section class="pageMain">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.dining-page.update', $content->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('push')
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="hero_content" id="hero_content" cols="30" rows="10" class="tinyEditor">{{ old('hero_content', $content->hero_content) }}</textarea>
                                @error('hero_content')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($content->hero_background_image)
                                    <img class="img-fluid" src="{{ Storage::url($content->hero_background_image) }}" style="display: block; height: 150px; margin-left: 0; width: auto;">
                                @else
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="book_banner_button_content" id="book_banner_button_content" value="{{ old('book_banner_button_content', $content->book_banner_button_content) }}">
