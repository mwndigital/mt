                    ...
                    <form action="{{ route('admin.dining-page.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="hero_content" id="hero_content" cols="30" rows="10" class="tinyEditor">{{ old('hero_content') }}</textarea>
                                @error('hero_content')
                                    <div class="text-danger">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="book_banner_button_content" id="book_banner_button_content" value="{{ old('book_banner_button_content') }}">
