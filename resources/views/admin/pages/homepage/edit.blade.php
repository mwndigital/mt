...
@section('content')
    ...
    <section class="pageMain mb-4">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <form action="{{ route('admin.homepage.update', ['homepage' => $hpcontent->id]) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="page_title" id="page_title"
                                       value="{{ old('page_title', $hpcontent->page_title) }}">
                                @error('page_title')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="hero_banner_title" id="hero_banner_title"
                                       value="{{ old('hero_banner_title', $hpcontent->hero_banner_title) }}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="hero_banner_content" id="hero_banner_content"
                                       value="{{ old('hero_banner_content', $hpcontent->hero_banner_content) }}"
                                       required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($hpcontent->hero_banner_background_image)
                                    <img class="img-fluid"
                                         src="{{ Storage::url($hpcontent->hero_banner_background_image) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($hpcontent->banner_one_image)
                                    <img class="img-fluid" src="{{ Storage::url($hpcontent->banner_one_image) }}"
                                         style="display: block; height: 150px; margin-left: 0; width: auto;">
                                @else
                                    No featured image currently set
                                @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="banner_one_title" id="banner_one_title"
                                       value="{{ old('banner_one_title', $hpcontent->banner_one_title) }}">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="banner_one_content" id="banner_one_content" cols="30" rows="10"
                                          class="tinyEditor">{{ old('banner_one_content', $hpcontent->banner_one_content) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="banner_one_button_link" id="banner_one_button_link"
                                       value="{{ old('banner_one_button_link', $hpcontent->banner_one_button_link) }}"
                                       required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="rooms_banner_sub_title" id="rooms_banner_sub_title"
                                       value="{{ old('rooms_banner_sub_title', $hpcontent->rooms_banner_sub_title) }}"
                                       required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="rooms_banner_title" id="rooms_banner_title"
                                       value="{{ old('rooms_banner_title', $hpcontent->rooms_banner_title) }}" required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="rooms_banner_content" id="rooms_banner_content" cols="30" rows="10"
                                          class="tinyEditor">{{ old('rooms_banner_content', $hpcontent->rooms_banner_content) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="rooms_banner_button_link" id="rooms_banner_button_link"
                                       value="{{ old('rooms_banner_button_link', $hpcontent->rooms_banner_button_link) }}"
                                       required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="spend_night_banner_title" id="spend_night_banner_title"
                                       value="{{ old('spend_night_banner_title', $hpcontent->spend_night_banner_title) }}"
                                       required>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="spend_night_banner_content" id="spend_night_banner_content" cols="30"
                                          rows="10"
                                          class="tinyEditor">{{ old('spend_night_banner_content', $hpcontent->spend_night_banner_content) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="spend_night_banner_button_link"
                                       ...
                                       value="{{ old('spend_night_banner_button_link', $hpcontent->spend_night_banner_button_link) }}"
                                       required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="file" name="spend_night_banner_background_image"
                                       id="spend_night_banner_background_image">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($hpcontent->spend_night_banner_background_image)
                                    <img class="img-fluid"
                                         src="{{ Storage::url($hpcontent->spend_night_banner_background_image) }}"
                                         style="display: block; height: 150px; margin-left: 0; width: auto;">
                                @else
                                    No featured image currently set
                                @endif
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="page_description" id="page_description" cols="30"
                                          rows="10">{{ old('page_description', $hpcontent->page_description) }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="page_keywords" id="page_keywords" cols="30"
                                          rows="10">{{ old('page_keywords', $hpcontent->page_keywords) }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($hpcontent->page_image)
                                    <img class="img-fluid" src="{{ Storage::url($hpcontent->page_image) }}"
                                         style="display: block; height: 150px; margin-left: 0; width: auto;">
                                @else
