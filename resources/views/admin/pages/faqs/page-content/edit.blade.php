                    ...
                    <form action="{{ route('admin.faqs-page.update', ['faqs_page' => 1]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <input type="text" name="main_title" id="main_title" value="{{ old('main_title', $content->main_title) }}" required>
                                @error('main_title')
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <textarea name="sub_title" id="sub_title" cols="30" rows="10" class="tinyEditor" required>{{ old('sub_title', $content->sub_title) }}</textarea>
                                @error('sub_title')
                                <div class="text-danger">
                                    {{ $message }}
                                </div>
