        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 wow slideInRight" data-wow-duration="1s">
                    ...
                    <p>
                        Around the local area you will find the world renowned Walkers Shortbread bakery, as well as the Aberlour Distillery, both well worth a visit.  Many of the local distilleries have visitors centres and shops and offer tours where you can sample some of Scotlands finest whisky.  For the more adventurous among you, there is plenty of sport to be had, such as clay pegeon shooting, horse back riding and canoeing, as well as skiing and snowboarding on the cairngorms.
                    </p>
                    <p>
                    ...
                    <p>
                        Don't forget to take a walk around Aberlour as the streets are adorned with local cafe's, bakeries, arts, crafts and gift shops.
                    </p>
                </div>
            </div>
        </div>
