...
@section('content')
    <section id="homepageTop">
        <img class="img-fluid mainBgImage" src="{{ Storage::url($hpcontent->hero_banner_background_image) }}"
             alt="Mash Tun outside image">
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        <div class="inner wow slideInLeft" data-wow-duration="1.2s">
                            ...
                            <h4 class="wow slideInRight" data-wow-duration="1s" data-wow-delay=".3s">in the heart of
                                Aberlour</h4>
                            {{--<p>
                            ...
                            <p>
                                Nestled within the banks of the River Spey, surrounded by the picturesque landscape of
                                Aberlour.
                            </p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    ...
                    <img class="img-fluid wow slideInLeft" data-wow-duration="1s" data-wow-delay=".4s"
                         src="{{ asset('images/homepage-image-one.png') }}">
                </div>
                <div class="col-lg-6 offset-lg-1 wow slideInRight" data-wow-duration="1.2s" data-wow-delay=".4s">
                    ...
                    <p>
                        The Mash Tun offers the aspirational opportunity to experience Speyside in all its wonder.. from
                        unparalleled fly fishing, hunting to horseback riding and hiking.
                    </p>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 wow slideInLeft">
                    ...
                    <p>
                        However it is the whisky that motivates a pilgrimage to this considered place, surrounded by the
                        most famous of distilleries viewed as the ultimate trip for the lover of the Uisge Beatha (water
                        of life)
                    </p>
                </div>
                <div class="col-lg-5 offset-lg-1">
                    <img class="img-fluid wow slideInRight" data-wow-duration="1s" data-wow-delay=".4s"
                         src="{{ asset('images/homepage-bar-image.png') }}">
                </div>
            </div>
        </div>
    </section>
    <section id="homepageBannerThree" class="homepageBanner">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img class="img-fluid wow slideInLeft" data-wow-duration="1s" data-wow-delay=".4s"
                         src="{{ asset('images/homepage-banner-3-seating.png') }}">
                </div>
                <div class="col-lg-6 offset-lg-1 wow slideInRight">
                    ...
                    <p>
                        So step into our wee world... where we can assist with all of your plans... offering the finest
                        highland hospitality, in our super comfy, whisky themed rooms, some with a beautiful view of the
                        river. You will find a warm welcome, comfortable refurbished accommodation, freshly prepared
                        food and an astonishing array of whiskies including what is thought to be the worlds only
                        complete <strong>Glenfarclas Family Collection</strong>.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1 wow slideInRight">
                    ...
                    <p>
                        Our 4 bedroom, 4 bathroom Stalla Dhu lodge has a luxury log cabin feel. It offers sumptuous and
                        luxury accommodation, including an expansive first floor sun terrace with views of the river
                        Spey. It is available as a self contained property and can accommodate 2-8 people.
                    </p>
    ...
    <section class="ourRatingsBanner">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="reviewItem">
                        <a href="https://foursquare.com/v/the-mash-tun/4c6ab4dca3932c7a12ebfdf4" rel="nofollow"
                           target="_blank">
    ...
    <section id="homepageBookRoomBanner"
             style="background: linear-gradient(to bottom, rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('{{--{{ Storage::url($hpcontent->spend_night_banner_background_image) }}--}}{{ asset('images/rooms/_DSC1684.jpg') }}'); background-attachment: fixed; background-position: top center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{ $hpcontent->spend_night_banner_button_link }}" class="blueBtn">Book a room <i
