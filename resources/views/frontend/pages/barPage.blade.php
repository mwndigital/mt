...
@section('content')
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="btn-group">s
                            <button type="button" class="darkGoldBtn" data-bs-toggle="modal"
                                    data-bs-target="#viewWineMenuModal">Wine List
                            </button>
                            <button type="button" class="blueBtn" data-bs-toggle="modal"
                                    data-bs-target="#viewWhiskyMenuModal">Whisky Flights Menu
                            </button>
                            <button type="button" class="darkGoldBtn" data-bs-toggle="modal"
                                    data-bs-target="#viewCocktailsMenuModal">Cocktails List
                            </button>
                            <button type="button" class="blueBtn" data-bs-toggle="modal"
                                    data-bs-target="#viewWhiskySpiritsMenuModal">Whisky & Spirits Menu
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <button type='button' class="blueBtn" data-bs-toggle="modal" data-bs-target="#viewWhiskyMenuModal">
                        Whisky Menu
                    </button>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    ...
                    <button type='button' class="blueBtn" data-bs-toggle="modal" data-bs-target="#viewWineMenuModal">
                        Wine Menu
                    </button>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <button type='button' class="blueBtn" data-bs-toggle="modal"
                            data-bs-target="#viewCocktailsMenuModal">Cocktails Menu
                    </button>
                </div>
                <div class="col-lg-6">
    ...
    <section class="makeBookingBanner"
             style="background: linear-gradient(to bottom, rgba(0,0,0, 0.4), rgba(0,0,0,0.4)), url('{{ Storage::url($content->book_banner_background_image) }}'); background-attachment: fixed; background-position: bottom center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="row">
                <div class="col-12">
